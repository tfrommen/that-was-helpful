		...
		makepot     : {
			pot: {
				options: {
					cwd        : '..',
					exclude    : [ 'resources' ],
					mainFile   : 'that-was-helpful.php',
					potComments: 'Copyright (C) {{year}} That Was Helpful\nThis file is distributed under the same license as the That Was Helpful package.',
					potFilename: '<%= globalConfig.textdomain %>.pot',
					potHeaders : {
						poedit                 : true,
						'report-msgid-bugs-to' : 'https://github.com/tfrommen/that-was-helpful/issues',
