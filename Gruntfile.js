...
module.exports = function( grunt ) {
	...
	var configObject = {
		...
		concat: {
			...
			admin  : {
				src : [
					'<%= config.scripts_src %>frontend.js',
					'<%= config.scripts_src %>frontend/*.js'
				],
				dest: '<%= config.scripts_path %>frontend.js'
			}
		},
